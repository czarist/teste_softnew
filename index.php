...
<head>
  <title>PHP Jquery Ajax CRUD - Teste Softnew</title>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-lg-12 margin-tb">
        <div class="pull-left">
          <h2>PHP Jquery Ajax CRUD - Teste Softnew</h2>
        </div>
        <div class="pull-right mt-5 ">
          <button style="margin-top: 1pc;" button" class="btn btn-success mt-5" data-toggle="modal" data-target="#create-item">
            Criar Item
          </button>
        </div>
      </div>
